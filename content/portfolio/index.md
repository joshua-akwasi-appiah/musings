...
<section class="portfolio-hero">
  ...
  <div class="portfolio-actions">
    ...
    <a class="portfolio-button secondary" href="#contact">Get in touch</a>
  </div>
</section>
...
<div class="portfolio-projects" id="featured-work">
  <a class="project-card project-ai" href="./ai-master-programme"><span class="project-number">01</span><span class="project-type">12 sessions · Internal programme</span><strong>AI Master Programme</strong><small>A staged programme designed to help people move from hesitation to practical AI adoption.</small><em>Read case study →</em></a>
  <a class="project-card project-safety" href="./psychological-safety-programme"><span class="project-number">02</span><span class="project-type">17-week programme</span><strong>Psychological Safety</strong><small>A learning journey about trust, tension, decision-making and empowered teams.</small><em>Read case study →</em></a>
  <a class="project-card project-ownership" href="./ownership-mindset-programme"><span class="project-number">03</span><span class="project-type">14-week programme</span><strong>Ownership Mindset</strong><small>From waiting for direction to taking responsibility for what needs to be done.</small><em>Read case study →</em></a>
  <a class="project-card project-culture" href="./world-class-culture-programme"><span class="project-number">04</span><span class="project-type">4-week internal programme</span><strong>Building a World-Class Culture</strong><small>A focused programme on self-leadership, standards and working together.</small><em>Read case study →</em></a>
  <a class="project-card project-commercial" href="./commercial-conversations-and-client-value"><span class="project-number">05</span><span class="project-type">14-week programme · Facilities services</span><strong>Commercial Conversations &amp; Client Value</strong><small>Helping a sales and client-relations team connect services to the outcomes clients care about.</small><em>Read case study →</em></a>
  <a class="project-card project-leadership" href="./operational-ownership-and-leadership"><span class="project-number">06</span><span class="project-type">14-week programme · Facilities services</span><strong>Operational Ownership &amp; Leadership</strong><small>Developing frontline leaders through accountability, coaching and operational resilience.</small><em>Read case study →</em></a>
</div>

## Frameworks and approaches

<section class="framework-preview"><div><p class="portfolio-kicker">A practical language for action</p><h2>Frameworks are useful when they help people see what to do next.</h2></div><div><p>I have developed and adapted frameworks to help people talk about authority, ownership, tension, trust, recognition and clearer decisions. The public version explains their purpose without sharing proprietary programme materials.</p><a href="./frameworks">Explore frameworks and approaches →</a></div></section>
